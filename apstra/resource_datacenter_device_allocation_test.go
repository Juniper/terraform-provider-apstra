				...
				},
				{
					config: deviceAllocation{
						...
						systemAttributes: &systemAttributes{
							...
							deployMode: utils.StringersToFriendlyString(apstra.DeployModeDrain),
							tags:       []string{"two", "2"},
						},
					},
					checks: []resource.TestCheckFunc{
						...
						resource.TestCheckResourceAttr(resourceDataCenterDeviceAllocationRefName, "interface_map_name", "Juniper_vQFX__AOS-8x10-1"),
						resource.TestCheckResourceAttrSet(resourceDataCenterDeviceAllocationRefName, "device_profile_node_id"),
						resource.TestCheckResourceAttr(resourceDataCenterDeviceAllocationRefName, "deploy_mode", utils.StringersToFriendlyString(apstra.DeployModeDrain)),
						...
						resource.TestCheckResourceAttr(resourceDataCenterDeviceAllocationRefName, "system_attributes.deploy_mode", utils.StringersToFriendlyString(apstra.DeployModeDrain)),
