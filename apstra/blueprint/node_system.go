		...
		"tag_ids": dataSourceSchema.SetAttribute{
			...
			Validators: []validator.Set{
				...
				setvalidator.AtLeastOneOf(
					...
					path.MatchRelative().AtParent().AtName("label"),
					path.MatchRelative().AtParent().AtName("role"),
					path.MatchRelative().AtParent().AtName("system_id"),
					path.MatchRelative().AtParent().AtName("system_type"),
					path.MatchRelative().AtParent().AtName("tag_ids"),
					//path.MatchRoot("hostname"),
					//path.MatchRoot("label"),
					//path.MatchRoot("role"),
					//path.MatchRoot("system_id"),
					//path.MatchRoot("system_type"),
