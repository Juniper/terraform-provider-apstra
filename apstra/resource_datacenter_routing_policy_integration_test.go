			...
			steps: []testStep{
				...
				},
				{
					config: resourceDatacenterRoutingPolicy{
						...
						importPolicy: pointer.To(apstra.DcRoutingPolicyImportPolicyExtraOnly),
						extraImports: []resourceDatacenterRoutingPolicyExtraImportExport{
							{prefix: "11.2.3.0/24", geMask: pointer.To(25), leMask: pointer.To(30), action: pointer.To(apstra.PrefixFilterActionDeny)},
							{prefix: "12.2.3.0/24", geMask: pointer.To(25), leMask: pointer.To(30), action: pointer.To(apstra.PrefixFilterActionDeny)},
							{prefix: "13.2.3.0/24", geMask: nil, leMask: pointer.To(30), action: pointer.To(apstra.PrefixFilterActionDeny)},
							{prefix: "14.2.4.0/24", geMask: pointer.To(25), leMask: nil, action: pointer.To(apstra.PrefixFilterActionDeny)},
							{prefix: "15.2.4.0/24", geMask: nil, leMask: nil, action: nil},
							{prefix: "3fff:1::/56", geMask: nil, leMask: pointer.To(64), action: pointer.To(apstra.PrefixFilterActionPermit)},
						},
						extraExports: []resourceDatacenterRoutingPolicyExtraImportExport{
							{prefix: "21.2.3.0/24", geMask: pointer.To(25), leMask: pointer.To(30), action: pointer.To(apstra.PrefixFilterActionDeny)},
							{prefix: "22.2.3.0/24", geMask: pointer.To(25), leMask: pointer.To(30), action: pointer.To(apstra.PrefixFilterActionDeny)},
							{prefix: "23.2.3.0/24", geMask: nil, leMask: pointer.To(30), action: pointer.To(apstra.PrefixFilterActionDeny)},
							{prefix: "24.2.4.0/24", geMask: pointer.To(25), leMask: nil, action: pointer.To(apstra.PrefixFilterActionDeny)},
							{prefix: "25.2.4.0/24", geMask: nil, leMask: nil, action: nil},
							{prefix: "3fff:2::/56", geMask: nil, leMask: pointer.To(64), action: pointer.To(apstra.PrefixFilterActionPermit)},
						},
						exportPolicy: &resourceDatacenterRoutingPolicyExportPolicy{
						...
						aggregatePrefixes: []fmt.Stringer{
							pointer.To(randomPrefix(t, "192.0.2.0/24", 28)),
							pointer.To(randomPrefix(t, "3fff::/20", 48)),
						},
						expectDefaultIPv4: pointer.To(true),
						expectDefaultIPv6: pointer.To(false),
					},
				},
				{
					config: resourceDatacenterRoutingPolicy{
			...
			steps: []testStep{
				...
				},
				{
					config: resourceDatacenterRoutingPolicy{
						...
						importPolicy: pointer.To(apstra.DcRoutingPolicyImportPolicyExtraOnly),
						extraImports: []resourceDatacenterRoutingPolicyExtraImportExport{
							{prefix: "31.2.3.0/24", geMask: pointer.To(25), leMask: pointer.To(30), action: pointer.To(apstra.PrefixFilterActionDeny)},
							{prefix: "32.2.3.0/24", geMask: pointer.To(25), leMask: pointer.To(30), action: pointer.To(apstra.PrefixFilterActionDeny)},
							{prefix: "33.2.3.0/24", geMask: nil, leMask: pointer.To(30), action: pointer.To(apstra.PrefixFilterActionDeny)},
							{prefix: "34.2.4.0/24", geMask: pointer.To(25), leMask: nil, action: pointer.To(apstra.PrefixFilterActionDeny)},
							{prefix: "35.2.4.0/24", geMask: nil, leMask: nil, action: nil},
							{prefix: "3fff:3::/56", geMask: nil, leMask: pointer.To(64), action: pointer.To(apstra.PrefixFilterActionPermit)},
						},
						extraExports: []resourceDatacenterRoutingPolicyExtraImportExport{
							{prefix: "41.2.3.0/24", geMask: pointer.To(25), leMask: pointer.To(30), action: pointer.To(apstra.PrefixFilterActionDeny)},
							{prefix: "42.2.3.0/24", geMask: pointer.To(25), leMask: pointer.To(30), action: pointer.To(apstra.PrefixFilterActionDeny)},
							{prefix: "43.2.3.0/24", geMask: nil, leMask: pointer.To(30), action: pointer.To(apstra.PrefixFilterActionDeny)},
							{prefix: "44.2.4.0/24", geMask: pointer.To(25), leMask: nil, action: pointer.To(apstra.PrefixFilterActionDeny)},
							{prefix: "45.2.4.0/24", geMask: nil, leMask: nil, action: nil},
							{prefix: "3fff:4::/56", geMask: nil, leMask: pointer.To(64), action: pointer.To(apstra.PrefixFilterActionPermit)},
						},
						exportPolicy: &resourceDatacenterRoutingPolicyExportPolicy{
						...
						expectDefaultIPv6: pointer.To(true),
					},
				},
			},
		},
