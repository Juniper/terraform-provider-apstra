			...
			"filter": schema.SingleNestedAttribute{
				...
				Validators: []validator.Object{
					...
					apstravalidator.AtLeastNAttributes(
						...
						"encapsulate_inner_vlan", "ipv4_connectivity_enabled", "ipv6_connectivity_enabled", "ipv4_subnet",
						"ipv6_subnet", "ipv4_virtual_gateway_enabled", "ipv6_virtual_gateway_enabled", "ipv4_virtual_gateway",
...
func (o *dataSourceDatacenterVirtualNetworks) setBpClientFunc(f func(context.Context, string) (*apstra.TwoStageL3ClosClient, error)) {
	o.getBpClientFunc = f
}
