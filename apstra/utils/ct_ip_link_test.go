...
func TestThing2(t *testing.T) {
	...
	apId := "IZiK1TY0amaN8UfU9Gc"
	ctIds := []string{
		//"5765435a-acdd-46e7-81dc-a884dc4478ab",
		//"d7d2daa1-4b15-4db6-8982-d4ff64a6a723",
		//"2d2cb4f3-9603-4daa-83c1-5c0f142bb6da",
	}

	vlanToSubinterfaces := GetCtIpLinkIdsByApAndCts(ctx, bp, apId, ctIds, &diags)
	require.False(t, diags.HasError())
