...
var _ datasource.DataSource = &dataSourceDatacenterCtVnMultiple{}

type dataSourceDatacenterCtVnMultiple struct{}

func (o *dataSourceDatacenterCtVnMultiple) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_datacenter_ct_virtual_network_multiple"
}
...
func (o *dataSourceDatacenterCtVnMultiple) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config connectivitytemplate.VnMultiple
